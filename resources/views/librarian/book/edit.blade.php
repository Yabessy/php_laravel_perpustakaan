    ...
    <form action="{{ route('admin.books.update', $book->id) }}" enctype="multipart/form-data" method="POST"
      ...
      <div class='flex flex-col gap-0.5 mb-3 col-span-1'>
        ...
        <input type='date' id='release_date' name='release_date' required
          class="bg-gray-200 border-black border col-span-2" value="{{ old('release_date') ?? $book->release_date }}">
      </div>
      <div class='flex flex-col gap-0.5 mb-3 col-span-1'>
        <label class="inline-block" for='publisher'>Publisher</label>
        <input type='text' id='publisher' name='publisher' required
          class="bg-gray-200 border-black border col-span-2" value="{{ old('publisher') ?? $book->publisher }}">
      </div>
      <div class='flex flex-col gap-0.5 mb-3 col-span-1'>
      ...
      <div class='flex flex-col gap-0.5 mb-3 col-span-1'>
        ...
        <textarea type='text' id='synopsis' name='synopsis' required class="bg-gray-200 border-black border col-span-2">{{ $book->synopsis }}</textarea>
      </div>
      <div class='flex flex-col gap-0.5 mb-3 col-span-1'>
        ...
        <input type='number' id='remaining_books' name='remaining_books' required
          ...
          value="{{ old('remaining_books') ?? $book->remaining_books }}">
      </div>
      <div class='flex flex-col gap-0.5 mb-3 col-span-1'>
